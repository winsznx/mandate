...
import { GRID_A_POLICY, describePolicy } from "./policy.js";
...
export const DISPLAY_NAME = "Tight Grid" as const;

export const DESCRIPTION =
  "Runs a fixed grid ladder with closely-spaced rungs, harvesting small oscillations and carrying more open orders as a result. " +
...
export function createStrategy(): AgentExecutor {
  return pendingStrategy({
    ...
    policy: describePolicy(GRID_A_POLICY),
  });
}
