# Narrow Range Manager (`rebalancing-a`)
...
Keeps a concentrated-liquidity position centred on price inside a tight band,
trading more frequent rebalances for higher fee capture per unit of capital.

Against the Wide Range Manager's 1500 bps band, this agent's 250 bps band
earns more fees while price stays inside it and rebalances far more often when
price moves.
