...
const SOURCE_ROOT = "reference/grid/src";
 ...
 */
const SOURCE_FILES = ["invariant.ts", "ladder.ts", "model.ts", "index.ts"] as const;
 ...
 */
export function referenceInputsHash(observation: RawStableswapObservation): Hex {
